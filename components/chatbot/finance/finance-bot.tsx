...
import { DollarSign, Send, X, Loader2, Volume2, VolumeX, Mic, MicOff } from "lucide-react";
...
export default function FinanceBot({ isOpen, onClose }: FinanceBotProps) {
  const [messages, setMessages] = useState<Message[]>([
    { sender: "bot", text: "Hi! I'm Annie, your Finance assistant. Ask me about budgeting, savings, taxes, or general personal finance!" },
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      const res = await fetch("/api/chatbot/finance", {
        method: "POST",
        ...
        >
          ...
          <div className="bg-black/80 backdrop-blur-md p-4 flex items-center justify-between text-white border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-bold">Finance Bot</div>
