...
export default function HealthBot({ isOpen, onClose }: HealthBotProps) {
  const [messages, setMessages] = useState<Message[]>([
    { sender: "bot", text: "Hi! I'm Annie, your Health & Wellness assistant. Ask me about lifestyle, nutrition, or general wellness tips!" },
  ]);
        ...
        >
          ...
          <div className="bg-black/80 backdrop-blur-md p-4 flex items-center justify-between text-white border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-bold">Health Bot</div>
