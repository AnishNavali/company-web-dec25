...
import { TrendingUp, Send, X, Loader2, Volume2, VolumeX, Mic, MicOff } from "lucide-react";
...
export default function SalesBot({ isOpen, onClose }: SalesBotProps) {
  const [messages, setMessages] = useState<Message[]>([
    { sender: "bot", text: "Hi! I'm Annie, your Sales assistant. Ask me anything about sales, retail, or business policies!" },
  ]);
